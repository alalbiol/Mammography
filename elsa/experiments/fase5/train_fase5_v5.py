"""
experiments/fase5/train_fase5_v5.py
=====================================
E05_v5 — Augmentations básicas + RandAugment conservador.
"""
...
from experiments.fase5.augmentations_v5 import (
    get_geometric_transform_v5,
    get_intensity_transform_v5,
)
from data.ddsm_dataset import DDSM_Image_Dataset, BalancedBatchSampler
from torch.utils.data import DataLoader


class DDSMImageDataModuleV5(_OriginalDataModule):
    def train_dataloader(self):
        dataset = DDSM_Image_Dataset(
            ...
            geometrical_transform=get_geometric_transform_v5(),
            intensity_transform=get_intensity_transform_v5(),
...
if __name__ == "__main__":
    ...
    data_module = DDSMImageDataModuleV5(config=config)
