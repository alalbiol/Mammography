"""
experiments/fase5/train_fase5_v3.py
=====================================
E05_v3 — Aumentado moderado.
"""
...
from experiments.fase5.augmentations_v3 import (
    get_geometric_transform_v3,
    get_intensity_transform_v3,
)
from data.ddsm_dataset import DDSM_Image_Dataset, BalancedBatchSampler
from torch.utils.data import DataLoader


class DDSMImageDataModuleV3(_OriginalDataModule):
    def train_dataloader(self):
        dataset = DDSM_Image_Dataset(
            ...
            geometrical_transform=get_geometric_transform_v3(),
            intensity_transform=get_intensity_transform_v3(),
...
if __name__ == "__main__":
    ...
    data_module = DDSMImageDataModuleV3(config=config)
